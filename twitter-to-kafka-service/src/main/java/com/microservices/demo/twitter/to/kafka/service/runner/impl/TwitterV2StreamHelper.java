...
public class TwitterV2StreamHelper {
    ...
    public TwitterV2StreamHelper(TwitterToKafkaConfigData twitterToKafkaConfigData, TwitterKafkaStatusListener twitterKafkaStatusListener) {
    ...
    void connectStream(String bearerToken) throws IOException, URISyntaxException {
        ...
        URIBuilder uriBuilder = new URIBuilder(twitterToKafkaConfigData.getTwitterV2BaseUrl());//"https://api.twitter.com/2/tweets/search/stream"
    ...
    void createRules(String bearerToken, Map<String, String> rules) throws URISyntaxException, IOException {
        ...
        URIBuilder uriBuilder = new URIBuilder(twitterToKafkaConfigData.getTwitterV2RulesBaseUrl());//"https://api.twitter.com/2/tweets/search/stream/rules"
